...
public class hesapMakinesi {
    ...
    public static void main(String[] args) throws Exception {
        /*
         * Method overloading kullanarak bir tane hesap makinesi yapalım.
         * Toplama ve carpma metodlarini 2 veya 3 parametre alacak sekilde tasarlayalim.
         */
        ...
        while(true){
            ...
            try (Scanner scanner = new Scanner(System.in)) {
                ...
                if(islem.equals("1")){
                    ...
                    System.out.println("Ä°sleminiz Gecersiz!");
                }
            }
        }
    }
